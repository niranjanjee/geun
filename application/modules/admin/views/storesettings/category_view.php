        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $this->template->section;?> &raquo; Categories</h3>
			  <a href="/admin/storesettings/addcategory" class="pull-right btn btn-success">Add Category</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive no-padding">
				<?php
				$attributes = array('method' => 'get', 'name' => 'search_admin', 'id' => 'search_admin');
				echo form_open('admin/storesettings/category', $attributes);
				?>
              ...
              <table class="table table-hover">
				...
				if(count($categories) > 0){
					...
					<tr>
					  ...
					  <a href="/admin/storesettings/addcategory/<?php echo $c->id;?>" title="Edit Category"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
					  <a href="javascript:void(0);" title="Delete Category" class="delete-action" rel="/admin/storesettings/deletecat/<?php echo $c->id;?>"><i class="fa fa-times" aria-hidden="true"></i></a></td>
					</tr>
					<?php 
					}
				}else{
